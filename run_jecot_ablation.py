...
VARIANTS: tuple[AblationVariant, ...] = (
    ...
    AblationVariant(
        "m2_mea",
        "MEA-M2",
        "M2 with mutual-evidence attention query/support marginals",
        (
            "--hrot_variant",
            "J_ECOT_M2",
            "--hrot_ecot_rho_bank",
    ...
    AblationVariant(
        ...
        ("--hrot_variant", "J_ECOT_CARE", "--hrot_ecot_rho_bank", "0.80"),
    ),
    AblationVariant(
        "care_no_fwec",
        "CARE-FWEC",
        "CARE-UOT without Fisher-weighted episode cost",
        (
            "--hrot_variant",
            "J_ECOT_CARE",
            "--hrot_ecot_rho_bank",
    ...
    AblationVariant(
        "care_no_qesm",
        "CARE-QESM",
        "CARE-UOT without query energy saliency marginals",
        (
            "--hrot_variant",
            "J_ECOT_CARE",
            "--hrot_ecot_rho_bank",
    ...
    AblationVariant(
        "care_no_mdr",
        "CARE-MDR",
        "CARE-UOT without mass discriminability regularization",
        (
            "--hrot_variant",
            "J_ECOT_CARE",
            "--hrot_ecot_rho_bank",
