...
def build_ours_final_objective_score_variants():
    ...
    dustbin_base = _ours_final_base_args(score_mode="dustbin_ot")
    probe = [
        "--enable_ours_final_failure_probe",
        "true",
        "--ours_probe_common_margin",
    ...
    return [
        ...
        {
            "tag": "ours_final_score_dustbin_ot",
            "checkpoint_tag": "score_dustbin_ot",
            "label": (
                "Ours-Final Dustbin OT: learned unmatched bin for token rejection "
...
def parse_ours_final_variant_filter(variants_str):
    ...
    aliases = {
        ...
        "pect_no_global": "pect_no_global",
        "pect_global_res_w0p05": "pect_global_res_w0p05",
        "pect_global_only": "pect_global_only",
        "pect_full_ot": "pect_full_ot",
        "pect_partial_ot": "pect_partial_ot",
        "pect_class_pooled": "pect_class_pooled",
        "pect_cost_only": "pect_cost_only",
        ...
        "score_dustbin": "ours_final_score_dustbin_ot",
        "score_dustbin_ot": "ours_final_score_dustbin_ot",
